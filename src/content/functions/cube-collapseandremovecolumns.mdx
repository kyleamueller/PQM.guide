...
category: "Table"
description: "Collapses dimension attributes mapped to specified columns, removing them from the cube's tabular view and changing its granularity."
syntax: "Cube.CollapseAndRemoveColumns(cube as table, columnNames as list) as table"
returnType: "table"
returnDescription: "The cube table with the specified columns removed and the dimensional granularity collapsed accordingly."
parameters:
  - name: "cube"
    type: "table"
    required: true
