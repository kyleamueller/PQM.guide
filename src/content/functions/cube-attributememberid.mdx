...
category: "Table"
description: "Returns the unique member identifier from a dimension attribute member property value."
syntax: "Cube.AttributeMemberId(attribute as any) as any"
returnType: "any"
returnDescription: "The unique member identifier for the given attribute member property value, or null if the value is not a member property."
parameters:
  - name: "attribute"
    type: "any"
    required: true
    description: "A dimension attribute member property value from which to extract the unique member identifier."
compatibility:
  pbiDesktop: true
  pbiService: true
  excelDesktop: true
