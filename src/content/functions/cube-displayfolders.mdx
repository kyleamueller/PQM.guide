...
category: "Table"
description: "Returns a nested tree of tables representing the display folder hierarchy of objects available in the cube."
syntax: "Cube.DisplayFolders(cube as table) as table"
returnType: "table"
returnDescription: "A nested tree of tables representing the display folder hierarchy of dimensions, measures, and other objects in the cube."
parameters:
  - name: "cube"
    type: "table"
    required: true
