...
returnType: "function"
returnDescription: "A binary format function that reads an 8-byte IEEE 754 double-precision floating point value from binary data."
parameters:
  - name: "binary"
    type: "binary"
    required: true
    description: "The binary data to read the 8-byte double-precision floating point value from."
compatibility:
  pbiDesktop: true
  pbiService: true
  excelDesktop: true
