...
category: Table
description: >-
  Merges a dimension into the cube's filter context and expands specified
  dimension attributes as new columns.
syntax: >-
...
returnType: table
returnDescription: >-
  The cube table with the specified dimension attributes added as new columns
  and the filter context updated to the expanded granularity.
parameters:
  - name: cube
    type: table
    required: true
  ...
  - name: dimensionSelector
    ...
    required: true
    description: >-
      The dimension to merge into the cube's filter context. Typically a value
      from Cube.Dimensions.
  - name: attributeNames
    type: list
    required: true
    description: >-
      A list of dimension attribute names to expand as columns in the tabular
      view.
  - name: newColumnNames
    type: any
    required: false
