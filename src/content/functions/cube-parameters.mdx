...
category: Table
description: >-
  Returns a table containing the set of parameters that can be applied to a
  cube.
syntax: Cube.Parameters(cube as table) as table
returnType: table
returnDescription: >-
  A table listing the available parameters for the cube, where each parameter is
