...
If you've been building queries through the Power Query UI, you've already been writing M — every Applied Step you created generated M code behind the scenes. Now that you're reading and writing it directly, it's worth understanding what kind of language M actually is.

Power Query M is a **functional language**. It shares design principles with languages like F# rather than with VBA, Python, or SQL. This paradigm is not just an academic distinction: it explains why M behaves the way it does, and understanding it prevents entire categories of bugs.
